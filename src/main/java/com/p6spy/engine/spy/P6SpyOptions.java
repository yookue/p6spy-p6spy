...
import com.p6spy.engine.spy.appender.NoopLogger;
...
public class P6SpyOptions extends StandardMBean implements P6SpyLoadableOptions {
    ...
    static {
        ...
        defaults.put(DATABASE_DIALECT_DATE_FORMAT, "yyyy-MM-dd HH:mm:ss");
